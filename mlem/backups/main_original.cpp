...
int main()
{
    ...
    double data_poisson[8][1];

    int height3 = 52, width3 = 1;
    double ini_poisson[height3][width3];

    double dosemat[1][1000];
    double poissmat[52][1000];
    double dose_std = 0;
