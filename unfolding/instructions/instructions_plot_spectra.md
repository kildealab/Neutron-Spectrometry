...
| line_width | `1` | Comma-delimited list of spectra line widths. See [Root docs](https://root.cern.ch/doc/master/classTAttLine.html#L2). If only a single value, apply to all spectra. |
